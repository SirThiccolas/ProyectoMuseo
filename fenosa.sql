...
--
-- Servidor: 127.0.0.1
-- Temps de generació: 25-10-2024 a les 13:34:03
...
('B005', 'Museu d\'Història', 'B005.jpg', 1, 'Cráneo de mamut', 'Colección Prehistórica', 120.00, 80.00, 70.00, 3, 5, NULL, 'Restos fósiles', -10000, NULL, 9, 'Sala de fósiles', '2024-10-05', 1, 2, '2020-11-05', 'Donación de empresa privada', 'no', NULL, NULL, NULL, 6, 'Siberia', 'Siberia', NULL, 'B005-2020', 50000.00, 'Estudiado por paleontólogos en diversas universidades.', 'Cráneo de un mamut lanudo.', 'Este fósil fue descubierto en la región de Siberia.', 3, 3, NULL, 2);
